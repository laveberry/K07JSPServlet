...
-어플리케이션 영억에 저장된 속성은 모두 JSP(Servlet) 페이지에서
	공유된다.
...
Date mySqlDate = new Date(myUtilDate.getTime());
...
<body>
	...
	<!-- 
	 ...
	 -->
	 <!-- ♥
	 forward :  클라이언트의 정보를 가지고 이동함
	 redirect : 클라이언트 정보 가지지않고 단순 페이지 이동 -->
	<h3>포워드로 페이지 전달하기</h3>
	<%
	...
	<!-- 
		외부파일 인클루드 : include 지시어를 통해 페이지를
