...
<body>
	...
	URL주소창에는 요청된 페이지의 경로명이 보여지지만, 출력되는 페이지는
	새롭게 전달된 페이지의 내용을 출력하게된다.
	그러므로 사용자는 페이지 이동을 인지하지 못하지만, 내부적으로는 페이지전달(포워드)
	...
	새로운 페이지에 대한 요청을 하게된다. 이경우 request영역은 공유되지 않는다.
	웹브라우저의 주소창에는 새롭게 요청된 페이지의 경로명이 보여지게된다.
	 --%>
	 <!-- request영역 공유x -->
