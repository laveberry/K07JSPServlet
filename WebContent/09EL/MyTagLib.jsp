...
<body>
	...
	<ul>
		<li>
		주민번호:123456-1000000 : ${my:getGender("123456-1000000") }</li>
		<li>
		주민번호:123456-2000000 : ${my:getGender("123456-2000000") }</li>
		<li>
		주민번호:123456-9000000 : ${my:getGender("123456-9000000") }</li>
	</ul>
