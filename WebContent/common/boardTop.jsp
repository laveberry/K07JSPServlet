...
<div class="col-12">			 
	...
	%>
		<!-- 로그인이 안된상태(리스트에 첫 진입시) -->
			<li class="nav-item">
				<!-- href는 다 경로라고 생각해서 JS안적어주면 파일경로 찾게됨-->
			...
			<li class="nav-item">
				...
				<i class='fas fa-sign-in-alt' style='font-size:20px'></i>로그인</a>
			</li>
	<%
	}else{ 
	%>
		<!-- 로그인이 된 상태(글쓰기를 위해 회원인증 후) -->
			<li class="nav-item">
				<!-- onclick 무조건 이벤트감지하는리스너, 함수호출로 생각해서 javascript생략 가능 -->
