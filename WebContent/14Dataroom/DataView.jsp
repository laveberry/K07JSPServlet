...
<body>
   <div class="container">
      ...
      <button type="button" class="btn btn-success"
         onclick="location.href='../DataRoom/DataPassword?idx=${param.idx}&mode=delete&nowPage=${param.nowPage}&searchColumn=${param.searchColumn}&searchWord=${param.searchWord}';">
         	삭제하기</button>      
                  </div>
                  <!-- pr-5 : 패딩p,라이트r 우측의 패딩 띄워놓은것/ 마진m -->
                  <div class="col-6 text-right pr-5">        
                  <!-- 상세보기에서는  map.param -> param.nowPage 으로 변경. 그래야 nowPage null로 인식되서 페이지표시 안됨-->       
