...
<body>
	...
	JSTL의 import태그
		...
		액션태그는 (1)컴파일 먼저되고 (2)삽입되서 request영역만 공유됨..
	 -->
	<!-- include : 지시어와 액션태그를 통해 할수 있는데,
		지시어는 삽입후 컴파일하고, 액션태그는 컴파일 후 삽입함.
		컴파일 후 삽입하면 다른 페이지가 되므로 request.
		지시어는 page공유.
		: JSTL의 import는 위의 지시어와 액션태그 중 액션태그 같은 기능을 함. -->
	<h2>import 태그</h2>
