...
<body>
	...
	<h3>type="percent"</h3>
	money : <fmt:formatNumber value="0.2" type="percent" />
	...
	/*
		...
		new연산자를 통해 객체를 생성할수 없는 대표적인 클래스이다.
		getInstance()를 통해 이미 생성된 static형태의 객체를
		반환받아 사용하게된다.
	//싱글턴객체 -> 자바(11static-03번)
	*/
	NumberFormat nf = NumberFormat.getInstance(); //new대체 -> getInstance
