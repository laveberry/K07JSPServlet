...
<head>
<meta charset="UTF-8">
<title>05Cookie > CookieMain.jsp</title>
...
<body>
	...
	*/
	...
	<%--
		...
		즉, 새로고침하거나 다른페이지에 새로운 요쳥이 있을때 서버는
		쿠키를 확인할수 있게된다.
	 --%>
	<h2>쿠키를 설정하는 현재페이지에서 쿠키값 확인하기</h2>
	<%
	//request를 통해 쿠키값을 얻어온다. 여러개의 값이므로 배열로 반환한다.
