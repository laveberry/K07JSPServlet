...
<body>
	...
	<%
	/*
		방법1 : web.xml에서 설정하기(분 단위)
		
		web.xml에서 설정할때는 분단위로 설정되고, 만약 설정값이
		없다면 30분(1800초)으로 설정된다. 웹어플리케이션이 실행될때는
		web.xml의 설정값이 먼저 실행되고, 아래 JSP코드를 통한 설정이
		실행된다.

		방법2 : session내장객체를 사용해서 설정하기(초 단위)
	*/
