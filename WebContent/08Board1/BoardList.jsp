	...
	<button type="submit" class="btn btn-warning">
		<i class='fa fa-search' style='font-size:20px'></i>
			...
			<div class="row mt-3">
				...
				<tbody>
				<!-- 여기에 if문 들어가야함 for문안에 리스트반복 re-->
<%-- 				<%for(int i=1 ; i<=10 ; i++){ %>
/*				리스트반복
				<tr>
					<td width="10%" class="text-center">번호</td>
					<td width="50%" class="text-left"><a href="ViewSkin.jsp">제목<%=i %></a></td>
					<td width="15%" class="text-center">작성자</td>
					<td width="10%" class="text-center">조회수</td>
					<td width="15%"class="text-center">작성일</td>
